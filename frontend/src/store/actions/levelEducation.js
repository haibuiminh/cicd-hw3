...
export const updateLevelEducation = (_id, title) => dispatch => {
  ...
  const url = `/api/level-education/update-level-education`;
  axios
    .put(url, updated, {
      headers
    })
...
export const getListLevelEducation = searchString => dispatch => {
  ...
  const url = `/api/level-education/get-list-level-education${resultSearch}`;
  axios
    .get(url, {
      headers
    })
...
export const deleteLevelEducation = _id => dispatch => {
  ...
  const url = `/api/level-education/delete-level-education`;
