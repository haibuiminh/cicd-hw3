...
WebUI.click(findTestObject('Object Repository/Page_React App/a_List Level Education'))

WebUI.click(findTestObject('Object Repository/Page_React App/button_Add'))

WebUI.setText(findTestObject('Object Repository/Page_React App/input__ant-input'), 'Beginner')
